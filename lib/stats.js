...
function Stats(options) {
    this.settings = Hoek.applyToDefaults(Defaults.Stats, options || {});
    this._counts = Object.create(null);
    this._samples = Object.create(null);
    this._maxSamples = this.settings.maxSamples;
}
...
Stats.prototype = {
    ...
    resetSamples: function resetSamples(name) {
        ...
        this._samples[name] = new CBuffer(this._maxSamples);
    },
