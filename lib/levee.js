...
Levee.prototype.run = Zalgo.contain(function run(context, callback) {
    var self, start, timer;
    ...
    this.command.execute.call(this.command, context, function onresponse(err, data) {
        if (!timer) {
            return;
        }
